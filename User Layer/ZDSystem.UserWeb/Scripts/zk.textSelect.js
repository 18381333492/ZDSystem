...
function getPinYin(c) {
    var asc = __pinyin.getFirstLetter(c);
    return asc.toUpperCase();
}
// select helper
SelectHelper = new function () {
    ...
    this.init = function () {
        $("select").live({
            keypress: SelectHelper.getNextKeyItem
        });
        //        $("select").each(function () {
        //            //alert($(this).html());
        //            $(this).keypress(SelectHelper.getNextKeyItem);
        //        })
    }
    // 获取选项文本的首字符
    ...
    // 查找并选中匹配的选项
    this.getNextKeyItem = function (e) {
        ...
        } while (key2Char(e.which || e.keyCode) != getPinYin(getItemKeyChar(elm.options[index++])));
