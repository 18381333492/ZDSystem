...
{
    /// <summary>
    /// 逻辑处理：MOrderRefund(订单退款)
    /// </summary>
    public class OrderRefundHandler : IOrderRefundHandler
    {
        private IOrderRefundDataAccess dbAccess;
        public OrderRefundHandler()
        {
            dbAccess = DataAccessFactory.Instance.GetProvider<IOrderRefundDataAccess>();
        }
        /// <summary>
        /// 获取单条数据
        /// </summary>
        ...
        /// <returns></returns>
        public MOrderRefund GetData(string id)
        {
        ...
        /// <returns></returns>   
        public MOrderRefund GetSingleData(MOrderRefund query, string orderBy = "",
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public List<MOrderRefund> GetDataList(string orderBy = "")
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public List<MOrderRefund> GetDataList(MOrderRefund query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
            ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public DataSet GetDataSet(MOrderRefund query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public List<MOrderRefund> GetPagerDataList(MOrderRefund query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public DataSet GetPagerDataSet(MOrderRefund query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
            totalCount = dbAccess.GetCount(query, mmode, cmode);
        ...
        /// <returns></returns>
        public IResult Save(string id, MOrderRefund vo)
        {
            bool status=false;
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public IResult Save(MOrderRefund vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool CreateNew(MOrderRefund vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool Update(MOrderRefund vo)
        {
        ...
        /// <returns></returns>
        public object GetScalarByXmlTemplate(string xmlTemplateName, MOrderRefund vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public List<MOrderRefund> GetDataListByTemplate(string xmlTemplateName, MOrderRefund vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public DataSet GetDataSetByTemplate(string xmlTemplateName, MOrderRefund vo)
        {
        ...
        /// <param name="id">主键编号</param>
        /// <returns></returns>
        public MOrderRefund GetSingleDataByTemplate(string xmlTemplateName, MOrderRefund vo)
        {
