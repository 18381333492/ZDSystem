...
{
    /// <summary>
    /// 逻辑处理：MOperateLog(操作日志)
    /// </summary>
    public class OperateLogHandler : IOperateLogHandler
    {
        private IOperateLogDataAccess dbAccess;
        public OperateLogHandler()
        {
            dbAccess = DataAccessFactory.Instance.GetProvider<IOperateLogDataAccess>();
        }
        /// <summary>
        /// 获取单条数据
        /// </summary>
        ...
        /// <returns></returns>
        public MOperateLog GetData(string id)
        {
        ...
        /// <returns></returns>   
        public MOperateLog GetSingleData(MOperateLog query, string orderBy = "",
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public List<MOperateLog> GetDataList(string orderBy = "")
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public List<MOperateLog> GetDataList(MOperateLog query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
            ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public DataSet GetDataSet(MOperateLog query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public List<MOperateLog> GetPagerDataList(MOperateLog query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public DataSet GetPagerDataSet(MOperateLog query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
            totalCount = dbAccess.GetCount(query, mmode, cmode);
        ...
        /// <returns></returns>
        public IResult Save(string id, MOperateLog vo)
        {
            bool status=false;
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public IResult Save(MOperateLog vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool CreateNew(MOperateLog vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool Update(MOperateLog vo)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public int GetCount(MOperateLog query, MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <returns></returns>
        public object GetScalarByXmlTemplate(string xmlTemplateName, MOperateLog vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public List<MOperateLog> GetDataListByTemplate(string xmlTemplateName, MOperateLog vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public DataSet GetDataSetByTemplate(string xmlTemplateName, MOperateLog vo)
        {
        ...
        /// <param name="id">主键编号</param>
        /// <returns></returns>
        public MOperateLog GetSingleDataByTemplate(string xmlTemplateName, MOperateLog vo)
        {
