...
{
    /// <summary>
    /// 逻辑处理：MReceiptFundRecord(收款账户资金变动表)
    /// </summary>
    public class ReceiptFundRecordHandler : IReceiptFundRecordHandler
    {
        private IReceiptFundRecordDataAccess dbAccess;
        public ReceiptFundRecordHandler()
        {
            dbAccess = DataAccessFactory.Instance.GetProvider<IReceiptFundRecordDataAccess>();
        }
        /// <summary>
        /// 获取单条数据
        /// </summary>
        ...
        /// <returns></returns>
        public MReceiptFundRecord GetData(string id)
        {
        ...
        /// <returns></returns>   
        public MReceiptFundRecord GetSingleData(MReceiptFundRecord query, string orderBy = "",
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public List<MReceiptFundRecord> GetDataList(string orderBy = "")
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public List<MReceiptFundRecord> GetPagerDataList(MReceiptFundRecord query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
