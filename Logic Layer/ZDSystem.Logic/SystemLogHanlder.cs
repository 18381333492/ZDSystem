...
{
    /// <summary>
    /// 逻辑处理：MSystemLog(错误日志)
    /// </summary>
    public class SystemLogHandler : ISystemLogHandler
    {
        private ISystemLogDataAccess dbAccess;
        public SystemLogHandler()
        {
            dbAccess = DataAccessFactory.Instance.GetProvider<ISystemLogDataAccess>();
        }
        /// <summary>
        /// 获取单条数据
        /// </summary>
        ...
        /// <returns></returns>
        public MSystemLog GetData(string id)
        {
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public List<MSystemLog> GetDataList(string orderBy = "")
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public DataSet GetDataSet(MSystemLog query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
       ...
       public List<MSystemLog> GetPagerDataList(MSystemLog query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public DataSet GetPagerDataSet(MSystemLog query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
            totalCount = dbAccess.GetCount(query, mmode, cmode);
        ...
        /// <returns></returns>
        public IResult Save(string id, MSystemLog vo)
        {
            bool status=false;
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public IResult Save(MSystemLog vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool CreateNew(MSystemLog vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool Update(MSystemLog vo)
        {
        ...
        /// <returns></returns>
        public object GetScalarByXmlTemplate(string xmlTemplateName, MSystemLog vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public List<MSystemLog> GetDataListByTemplate(string xmlTemplateName, MSystemLog vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public DataSet GetDataSetByTemplate(string xmlTemplateName, MSystemLog vo)
        {
        ...
        /// <param name="id">主键编号</param>
        /// <returns></returns>
        public MSystemLog GetSingleDataByTemplate(string xmlTemplateName, MSystemLog vo)
        {
