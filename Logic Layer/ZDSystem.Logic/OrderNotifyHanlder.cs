...
{
    /// <summary>
    /// 逻辑处理：MOrderNotify(订单通知)
    /// </summary>
    public class OrderNotifyHandler : IOrderNotifyHandler
    {
        private IOrderNotifyDataAccess dbAccess;
        public OrderNotifyHandler()
        {
            dbAccess = DataAccessFactory.Instance.GetProvider<IOrderNotifyDataAccess>();
        }
        /// <summary>
        /// 获取单条数据
        /// </summary>
        ...
        /// <returns></returns>
        public MOrderNotify GetData(string id)
        {
        ...
        /// <returns></returns>   
        public MOrderNotify GetSingleData(MOrderNotify query, string orderBy = "",
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public List<MOrderNotify> GetDataList(string orderBy = "")
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public List<MOrderNotify> GetDataList(MOrderNotify query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
            ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public DataSet GetDataSet(MOrderNotify query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public List<MOrderNotify> GetPagerDataList(MOrderNotify query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public DataSet GetPagerDataSet(MOrderNotify query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
            totalCount = dbAccess.GetCount(query, mmode, cmode);
        ...
        /// <returns></returns>
        public IResult Save(string id, MOrderNotify vo)
        {
            bool status=false;
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public IResult Save(MOrderNotify vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool CreateNew(MOrderNotify vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool Update(MOrderNotify vo)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public int GetCount(MOrderNotify query, MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <returns></returns>
        public object GetScalarByXmlTemplate(string xmlTemplateName, MOrderNotify vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public List<MOrderNotify> GetDataListByTemplate(string xmlTemplateName, MOrderNotify vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public DataSet GetDataSetByTemplate(string xmlTemplateName, MOrderNotify vo)
        {
        ...
        /// <param name="id">主键编号</param>
        /// <returns></returns>
        public MOrderNotify GetSingleDataByTemplate(string xmlTemplateName, MOrderNotify vo)
        {
