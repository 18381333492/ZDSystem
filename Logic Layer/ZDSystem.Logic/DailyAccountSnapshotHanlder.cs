...
{
    /// <summary>
    /// 逻辑处理：MDailyAccountSnapshot(每日账户快照)
    /// </summary>
    public class DailyAccountSnapshotHandler : IDailyAccountSnapshotHandler
    {
        private IDailyAccountSnapshotDataAccess dbAccess;
        public DailyAccountSnapshotHandler()
        {
            dbAccess = DataAccessFactory.Instance.GetProvider<IDailyAccountSnapshotDataAccess>();
        }
        /// <summary>
        /// 获取单条数据
        /// </summary>
        ...
        /// <returns></returns>
        public MDailyAccountSnapshot GetData(string id)
        {
        ...
        /// <returns></returns>   
        public MDailyAccountSnapshot GetSingleData(MDailyAccountSnapshot query, string orderBy = "",
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public List<MDailyAccountSnapshot> GetDataList(string orderBy = "")
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public List<MDailyAccountSnapshot> GetDataList(MDailyAccountSnapshot query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
            ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public List<MDailyAccountSnapshot> GetPagerDataList(MDailyAccountSnapshot query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public DataSet GetPagerDataSet(MDailyAccountSnapshot query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
            totalCount = dbAccess.GetCount(query, mmode, cmode);
        ...
        /// <returns></returns>
        public IResult Save(string id, MDailyAccountSnapshot vo)
        {
            bool status=false;
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public IResult Save(MDailyAccountSnapshot vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool CreateNew(MDailyAccountSnapshot vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool Update(MDailyAccountSnapshot vo)
        {
        ...
        /// <returns></returns>
        public object GetScalarByXmlTemplate(string xmlTemplateName, MDailyAccountSnapshot vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public List<MDailyAccountSnapshot> GetDataListByTemplate(string xmlTemplateName, MDailyAccountSnapshot vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public DataSet GetDataSetByTemplate(string xmlTemplateName, MDailyAccountSnapshot vo)
        {
        ...
        /// <param name="id">主键编号</param>
        /// <returns></returns>
        public MDailyAccountSnapshot GetSingleDataByTemplate(string xmlTemplateName, MDailyAccountSnapshot vo)
        {
