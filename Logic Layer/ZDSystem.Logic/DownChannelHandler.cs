...
{
    public class DownChannelHandler : IDownChannelHandler
    {
        private IDownChannelDataAccess dbAccess;
        public DownChannelHandler()
        {
            dbAccess = DataAccessFactory.Instance.GetProvider<IDownChannelDataAccess>();
        }
        /// <summary>
        /// 获取单条数据
        /// </summary>
        ...
        /// <returns></returns>
        public MDownChannel GetData(string id)
        {
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public List<MDownChannel> GetDataList(string orderBy = "")
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public DataSet GetDataSet(MDownChannel query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public List<MDownChannel> GetPagerDataList(MDownChannel query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
               ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public DataSet GetPagerDataSet(MDownChannel query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
               ConnectMode cmode = ConnectMode.And)
        {
            totalCount = dbAccess.GetCount(query, mmode, cmode);
        ...
        /// <returns></returns>
        public IResult Save(string id, MDownChannel vo)
        {
            bool status = false;
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public IResult Save(MDownChannel vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool CreateNew(MDownChannel vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool Update(MDownChannel vo)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public int GetCount(MDownChannel query, MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <returns></returns>
        public object GetScalarByXmlTemplate(string xmlTemplateName, MDownChannel vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public List<MDownChannel> GetDataListByTemplate(string xmlTemplateName, MDownChannel vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public DataSet GetDataSetByTemplate(string xmlTemplateName, MDownChannel vo)
        {
        ...
        /// <param name="id">主键编号</param>
        /// <returns></returns>
        public MDownChannel GetSingleDataByTemplate(string xmlTemplateName, MDownChannel vo)
        {
